...
// const date = new Date();
// const po = `PO-${date.getSeconds()}${date.getMilliseconds()}-${SHA1("123232312DKSKS3").toString().substring(0,8)}`
...
//   to: "katieo3507@gmail.com",
//   subject: "Send Test Email",
//   text: "Testing out mails",
...
app.post('/api/users/reset_password',(req,res)=>{
  ...
  User.findOne({
    ...
    if(!user) return res.json({success:false,messag:'Sorry, token bad, generate a new one'})
